    ...
    m_pLabel(nullptr)
{
    ...
    m_pLabel->setPixmap(QPixmap(":/toolbar/down-arrow.png").scaled(m_pLabel->size(), Qt::IgnoreAspectRatio, Qt::SmoothTransformation));
...
void ToolPage::collapse()
{
    ...
    m_bIsExpanded = false;
    m_pLabel->setPixmap(QPixmap(":/toolbar/left-arrow.png").scaled(m_pLabel->size(), Qt::IgnoreAspectRatio, Qt::SmoothTransformation));
}
