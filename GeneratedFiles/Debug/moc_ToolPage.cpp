...
void ToolPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ToolPage *_t = static_cast<ToolPage *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject ToolPage::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ToolPage.data,
      qt_meta_data_ToolPage,  qt_static_metacall, nullptr, nullptr}
};
...
void *ToolPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ToolPage.stringdata0))
        return static_cast<void*>(const_cast< ToolPage*>(this));
