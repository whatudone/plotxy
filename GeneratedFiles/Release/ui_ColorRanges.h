...
public:
    ...
    void retranslateUi(QWidget *ColorRanges)
    {
        ...
        checkBox_8->setText(QApplication::translate("ColorRanges", "Enable", Q_NULLPTR));
        label->setText(QApplication::translate("ColorRanges", "Default color", Q_NULLPTR));
        pushButton->setText(QString());
        label_18->setText(QApplication::translate("ColorRanges", "Display Options", Q_NULLPTR));
        comboBox_5->clear();
        comboBox_5->insertItems(0, QStringList()
         << QApplication::translate("ColorRanges", "Single Color", Q_NULLPTR)
         << QApplication::translate("ColorRanges", "Sho Ranges", Q_NULLPTR)
         << QApplication::translate("ColorRanges", "Gradient", Q_NULLPTR)
        );
        label_19->setText(QApplication::translate("ColorRanges", "Edit Color Ranges", Q_NULLPTR));
        pushButton_more->setText(QApplication::translate("ColorRanges", "More>>", Q_NULLPTR));
    } // retranslateUi
