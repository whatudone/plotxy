...
public:
    ...
    void retranslateUi(QWidget *LabelText)
    {
        ...
        label_13->setText(QApplication::translate("LabelText", "Text Type    ", Q_NULLPTR));
        comboBox_3->clear();
        comboBox_3->insertItems(0, QStringList()
         << QApplication::translate("LabelText", "Default", Q_NULLPTR)
         << QApplication::translate("LabelText", "Custom", Q_NULLPTR)
         << QApplication::translate("LabelText", "Scripted", Q_NULLPTR)
        );
        label_14->setText(QApplication::translate("LabelText", "Scripted Text", Q_NULLPTR));
        pushButton_9->setText(QApplication::translate("LabelText", "More>>", Q_NULLPTR));
        label_15->setText(QApplication::translate("LabelText", "Bar Plot Text", Q_NULLPTR));
    } // retranslateUi
