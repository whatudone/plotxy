...
public:
    ...
    void retranslateUi(QWidget *Extrapolation)
    {
        ...
        checkBox_5->setText(QApplication::translate("Extrapolation", "Extrapolate(Live Data Only)", Q_NULLPTR));
        label_2->setText(QApplication::translate("Extrapolation", "Extrapolate Time Offset   ", Q_NULLPTR));
    } // retranslateUi
